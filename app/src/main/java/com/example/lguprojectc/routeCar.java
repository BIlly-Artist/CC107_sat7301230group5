...
public class routeCar extends AppCompatActivity {
        ...
        btTrack.setOnClickListener(new View.OnClickListener() {
                ...
                if(sSource.equals("")){
                    ...
                    btTrack.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Toast.makeText(routeCar.this, "They have already seen your place "
                                    , Toast.LENGTH_LONG).show();
                            Toast.makeText(routeCar.this, "You can follow the route if needed "
                                    , Toast.LENGTH_LONG).show();
            ...
            private void DisplaTrack(String sSource, String respo) {
                ...
                try{
                    ...
                    Uri uri = Uri.parse("google.navigation:q="+sSource+"&mode=d");
